...
public class NewsServiceImpl implements NewsService {
    ...
    @Transactional
    @Override
    public List<News> getAllOfferedNews(int offset, int noOfRecords) throws NewsServiceException {
        try {
            return newsDAO.getAllOfferedNews(offset, noOfRecords);
        } catch (DAOException e) {
            throw new NewsServiceException(e);
        }
    }
    ...
    @Transactional
    @Override
    public int getNumberOfAllOfferedNews() throws NewsServiceException {
        try {
            return newsDAO.getNumberOfAllOfferedNews();
        } catch (DAOException e) {
            throw new NewsServiceException(e);
        }
    }
    ...
    @Transactional
    @Override
    public void offerNews(News news) throws NewsServiceException {
        try {
            newsDAO.offerNews(news);
        } catch (DAOException e) {
            throw new NewsServiceException(e);
        }
    }
